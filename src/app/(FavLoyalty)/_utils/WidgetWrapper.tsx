...
const WidgetWrapper = (props: any) => {
  const { isBoxVisible, toggleFavWidget }: any = useContext(UserContext);

  return (
    <div className="FavWidget_Area">
      <div
        className={`FavWidget_Box FavLoyalty_card ${
