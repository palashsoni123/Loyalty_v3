        ...
        <div className="Widget_InnerPagesHeader">
          <div className="InnerPagesHeaderLeft_Area">
            <div className="Back_Button" onClick={() => router.back()}>
              ...
              >
                <path
                  d="M8.75471 17.433C8.59013 17.4339 8.42699 17.4024 8.27462 17.3402C8.12226 17.2779 7.98368 17.1862 7.86683 17.0703L0.363645 9.56714C0.130732 9.33284 0 9.01589 0 8.68551C0 8.35514 0.130732 8.03819 0.363645 7.80389L7.86683 0.300699C8.10606 0.0958291 8.41379 -0.011224 8.72852 0.000932624C9.04325 0.0130892 9.3418 0.14356 9.56451 0.366272C9.78722 0.588985 9.91769 0.887536 9.92985 1.20227C9.94201 1.51699 9.83495 1.82472 9.63008 2.06395L3.01477 8.67926L9.63008 15.2946C9.80569 15.4687 9.9257 15.6911 9.97495 15.9334C10.0242 16.1758 10.0005 16.4273 9.90679 16.6562C9.81309 16.8851 9.65363 17.0811 9.44856 17.2193C9.24349 17.3576 9.00203 17.4319 8.75471 17.433Z"
                  fill="white"
                />
              </svg>
            </div>
            <div className="Header_Text">
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="Heading_Text">{props.HeadingText}</div>
                </motion.div>
              </AnimatePresence>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="Subheading_Text">{props.SubHeadingText}</div>
                </motion.div>
              </AnimatePresence>
            </div>
          </div>
