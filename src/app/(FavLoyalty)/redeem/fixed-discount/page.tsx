"use client";
import ButtonMUI from "../../Asset/Button_RedeemCode";
import RangeSlider from "../../Asset/RangeSlider_FixDiscount";
    ...
    <>
      <div className="FixDiscountScreen">
        <div className="Favloyalty_SubScreens_Header">
          <Header
            HeadingText="Quick Discount"
            SubHeadingText="Swipe and get instant discount coupon"
            Navigate="Redeem"
          />
        </div>
            ...
            >
              <div className="upper-area">
                <div className="FavLoyalty_card Slider_Area">
                  <div className="Card_heading">Select Points to Redeem</div>
                  ...
                  <div className="value-enter-area">
                    <div className="value-input">
                      <input
                        className="FixDiscount_inputStyles"
                        id=":r4:"
                        placeholder="$60"
